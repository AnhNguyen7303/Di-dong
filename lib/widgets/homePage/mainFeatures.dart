...
class HealthNeeds extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<CustomIcon> customIcons = [
      CustomIcon(name: "Attendance", icon: 'assets/images/attendance2.png'),
      CustomIcon(name: "Mispunch", icon: 'assets/images/mispunch2.png'),
      CustomIcon(name: "Salary", icon: 'assets/images/salary.png'),
    ...
    List<CustomIcon> mainFeatures= [
      ...
      CustomIcon(name: "Mispunch", icon: 'assets/images/mispunch2.png'),
      CustomIcon(name: "Salary", icon: 'assets/images/salary.png'),
      CustomIcon(name: "HR Policies", icon: 'assets/images/salaryEmployee.png'),
    ];
    List<CustomIcon> nearbyEmployee = [
      CustomIcon(name: "Position", icon: 'assets/images/position.png'),
      CustomIcon(name: "Employee", icon: 'assets/images/employee.png'),
      CustomIcon(name: "Room", icon: 'assets/images/room.png'),
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Image.asset(
                                            nearbyEmployee[index].icon,
                                          ),
                                        ),
                                      ),
                                      const SizedBox(height: 6),
                                      Text(nearbyEmployee[index].name)
                                    ],
                                  );
                                },
                              ),
